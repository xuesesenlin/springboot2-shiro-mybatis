package com.zcgl.zcgl.publics.login.controller;
...
import com.zcgl.zcgl.sysConfig.shiro.token.MyUsernamePasswordToken;
import com.zcgl.zcgl.util.base64.Base64Util;
...
//            cookie方式
            ...
            for (int i = 0; i < cookies.length; i++) {
                if (cookies[i].getName().equals("token")) {
                    ...
                    cookie.setPath("/");
                    cookie.setMaxAge(0);
                    Cookie cookie2 = new Cookie("tokent", null);
                    cookie2.setPath("/");
                    cookie2.setMaxAge(0);
                    Cookie cookie3 = new Cookie("tokenu", null);
                    cookie3.setPath("/");
                    cookie3.setMaxAge(0);
                    response.addCookie(cookie);
                    response.addCookie(cookie2);
